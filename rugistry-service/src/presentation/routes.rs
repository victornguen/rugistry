...
use crate::application::services::{RegistryService, SpaceService, WebhookService};
...
pub fn create_router(
    ...
    let space_routes = Router::new()
        ...
        .route("/api/v1/spaces/:id/webhooks", get(handlers::list_webhooks))
        .route("/api/v1/spaces/:id/webhooks", post(handlers::create_webhook))
        .route("/api/v1/spaces/:id/webhooks/:webhook_id", delete(handlers::delete_webhook))
